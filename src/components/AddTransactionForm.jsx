...
const CATEGORIES = {
    ...
    expense: ["Housing", "Food", "Transportation", "Entertainment", "Health", "Utilities", "Other"],
};
...
export default function AddTransactionForm({ onAdd }) {
  ...
  return (
    <section className="bg-surface border border-hairline rounded-sm">
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        className="w-full flex items-center justify-between px-7 sm:px-9 py-5 text-left group"
        aria-expanded={open}
      >
      ...
      {open && (
        <div className="border-t border-hairline px-7 sm:px-9 py-6">
          <form onSubmit={handleSubmit} noValidate>
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <select
                  ...
                  className="w-full bg-paper border border-hairline rounded-sm px-3 py-2 text-sm text-ink font-sans appearance-none cursor-pointer focus:outline-none focus:border-ink"
                >
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <input
                  ...
                  className="w-full bg-paper border border-hairline rounded-sm px-3 py-2 text-sm font-mono text-ink focus:outline-none focus:border-ink"
                />
              </div>
              ...
              <div className="col-span-2">
                ...
                <input
                  type="text"
                  placeholder={
                    isIncome ? "e.g. June salary" : "e.g. Weekly groceries"
                  }
            ...
            {error && (
              <p className="font-mono text-[11px] text-expense mb-4">{error}</p>
            )}

            <button
              type="submit"
              className={`w-full py-2.5 px-4 rounded-sm font-mono text-[12px] uppercase tracking-[0.14em] text-surface transition-opacity hover:opacity-80 active:opacity-70 ${
